    ...
    <div>
      <div className="container">
        ...
        <div className="row custom-form">
          ...
          <Input id="carboidratos" label="CARBO" placeholder="" type={"text"} col={"4 ponta"}/>
          <Input id="fibra" label="FIBRA" placeholder="" type={"text"} col={4}/>
          <Input id="proteina" label="PROTEÍNA" placeholder="" type={"text"} col={4}/>
          <Input id="gordura" label="GORDURA" placeholder="" type={"text"} col={"4 ponta"}/>
          ...
          <div className="container">
            <div className="row" style={{margin: "10px 0"}}>
              <div className="col-12 ">
                  <button className="btn btn-primary" style={{width: "100%", padding: "10px 0"}}> CADASTRAR </button>
              </div>  
            </div> 
          </div> 
      </div>
