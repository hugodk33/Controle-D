      ...
      <div className="col-12 col-md-6 canvas-board"> 
        <div className="container">
          ...
          <div className="row custom-form">
              <div className={"col-12"}><h5 className="titulo-3"><i className={"fa fa-spinner"}/> PACIENTE </h5></div>
              ...
              <div className={"col-12"}><h5 className="titulo-3"><i className={"fa fa-spinner"}/> CONDIÇÃO </h5></div>
              ...
              <div className={"col-12"}><h5 className="titulo-3"><i className={"fa fa-spinner"}/> OBSERVAÇÕES </h5></div>
